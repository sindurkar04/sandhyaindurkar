...
const SYNONYMS: Record<string, string[]> = {
  ...
  matrix: ["matrices", "linear-system", "confusion", "classifier"],
  ...
  precision: ["recall", "threshold", "classifier", "auc"],
  recall: ["precision", "threshold", "classifier", "f1"],
  threshold: ["precision", "recall", "cutoff"],
  cutoff: ["threshold", "precision"],
  knn: ["k-nearest", "neighbors", "classification", "distance"],
  neighbors: ["knn", "nearest", "vote"],
  logistic: ["sigmoid", "classification", "regression"],
  sigmoid: ["logistic", "probability", "score"],
  "gradient-descent": ["optimizer", "learning-rate", "training"],
  optimizer: ["gradient-descent", "adam", "sgd"],
  "decision-tree": ["tree", "rules", "split", "interpretable"],
  tree: ["decision-tree", "split", "rules"],
  "cross-entropy": ["loss", "logistic", "training"],
  hinge: ["loss", "svm", "margin"],
  classifier: ["model", "ml", "score", "precision", "recall", "knn", "logistic"],
  accuracy: ["precision", "recall", "classifier"],
  auc: ["roc", "classifier", "ranker"],
  roc: ["auc", "curve", "classifier"],
  confusion: ["matrix", "tp", "fp", "classifier", "confusion-matrix"],
  "confusion-matrix": ["tp", "fp", "fn", "tn", "precision"],
  eval: ["labels", "metric", "holdout"],
  labels: ["eval", "labeled", "annotation"],
  f1: ["precision", "recall", "metric"],
  permutation: ["permutations", "order", "factorial", "arrange"],
  permutations: ["permutation", "order", "counting"],
  combination: ["combinations", "choose", "subset"],
  combinations: ["combination", "choose", "binomial"],
  choose: ["combination", "combinations", "binomial"],
  factorial: ["permutation", "combination", "counting"],
  determinant: ["determinants", "matrix", "singular", "area"],
  determinants: ["determinant", "matrix", "invertible"],
  eigenvalue: ["eigenvalues", "stretch", "pca", "lambda"],
  eigenvalues: ["eigenvalue", "pca", "characteristic"],
  eigenvector: ["eigenvectors", "direction", "pca", "axis"],
  eigenvectors: ["eigenvector", "principal", "pca"],
  scaling: ["z-score", "normalize", "standardize", "features"],
  "z-score": ["scaling", "standardize", "normalize"],
  standardize: ["z-score", "scaling", "normalize"],
  normalize: ["scaling", "z-score", "min-max"],
  bayes: ["bayesian", "posterior", "prior", "theorem"],
  posterior: ["bayes", "prior", "update"],
  prior: ["bayes", "posterior", "base-rate"],
  gaussian: ["normal", "bell", "distribution"],
  normal: ["gaussian", "bell", "distribution"],
  "bias-variance": ["overfitting", "underfitting", "complexity"],
  underfit: ["bias", "bias-variance", "underfitting"],
  underfitting: ["underfit", "bias", "bias-variance"],
  logarithm: ["log", "odds", "logit"],
  log: ["logarithm", "odds", "logit"],
  odds: ["logit", "probability", "logarithm"],
